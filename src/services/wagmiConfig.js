import {getDefaultWallets} from '@rainbow-me/rainbowkit';
  ...
  import { arbitrum, arbitrumGoerli, arbitrumNova, aurora, auroraTestnet, avalanche, avalancheFuji, bronos, bronosTestnet, bsc, bscTestnet, 
  ...
  export const { chains, provider } = configureChains(
    [mainnet, polygon, optimism, arbitrum, zkSync, zkSyncTestnet, goerli, sepolia],
    [
      publicProvider()
    ]
  );
