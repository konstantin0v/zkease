...
const ConditionalRender = ({ children }) => {
  ...
  if (router.pathname === "/") {
    return <div className={styles.forLanding}>{children}</div>;
  } else {
    return <>{children}</>;
  }
};
      ...
      <footer {...props}>
        <div className={styles.top}>
          ...
          <ul className={styles.top__menu}>
            <li>
              <Link href="https://forms.gle/7ySdaZT7iMNFxQ9o8" target="_blank">
                Submit project
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="https://forms.gle/Yahhjja5ev61hfC37" target="_blank">
                Contact support
              </Link>
            </li>
          </ul>
